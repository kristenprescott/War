...
const handleRedDesignChange = () => {
  ...
  computerPlayCard.innerHTML = `<img src="${imgBackPrefix}red.png" style="box-shadow:-1rem -1rem 1rem 0px rgba(0, 0, 0, 0.7);"></img>`;
  // player play card
  ...
  playerPlayCard.innerHTML = `<img src="${imgBackPrefix}red.png" style="box-shadow:-1rem -1rem 1rem 0px rgba(0, 0, 0, 0.7);"></img>`;
};
...
const handleBlueDesignChange = () => {
  ...
  blueComputerDesign.style.justifyContent = "space-around";
  const computerPlayCard = document.getElementById("computer-play-card");
  computerPlayCard.innerHTML = `<img src="${imgBackPrefix}blue.png" style="box-shadow:-1rem -1rem 1rem 0px rgba(0, 0, 0, 0.7);"></img>`;
  // player play card
  const bluePlayerPlayDesign = document.createElement("img");
  bluePlayerPlayDesign.style.display = "flex";
  bluePlayerDesign.style.justifyContent = "space-around";
  const playerPlayCard = document.getElementById("player-play-card");
  playerPlayCard.innerHTML = `<img src="${imgBackPrefix}blue.png" style="box-shadow:-1rem -1rem 1rem 0px rgba(0, 0, 0, 0.7);"></img>`;
};
...
const handleAbstractDesignChange = () => {
  ...
  abstractComputerDesign.style.justifyContent = "space-around";
  const computerPlayCard = document.getElementById("computer-play-card");
  computerPlayCard.innerHTML = `<img src="${imgBackPrefix}abstract.png" style="box-shadow:-1rem -1rem 1rem 0px rgba(0, 0, 0, 0.7);"></img>`;
  ...
  abstractPlayerDesign.style.justifyContent = "space-around";
  const playerPlayCard = document.getElementById("player-play-card");
  playerPlayCard.innerHTML = `<img src="${imgBackPrefix}abstract.png" style="box-shadow:-1rem -1rem 1rem 0px rgba(0, 0, 0, 0.7);"></img>`;
};
...
const handleAbstractCloudsDesignChange = () => {
  ...
  abstractCloudsComputerDesign.style.justifyContent = "space-around";
  const computerPlayCard = document.getElementById("computer-play-card");
  computerPlayCard.innerHTML = `<img src="${imgBackPrefix}abstractClouds.png" style="box-shadow:-1rem -1rem 1rem 0px rgba(0, 0, 0, 0.7);"></img>`;
  ...
  abstractCloudsPlayerDesign.style.justifyContent = "space-around";
  const playerPlayCard = document.getElementById("player-play-card");
  playerPlayCard.innerHTML = `<img src="${imgBackPrefix}abstractClouds.png" style="box-shadow:-1rem -1rem 1rem 0px rgba(0, 0, 0, 0.7);"></img>`;
};
...
const handleAbstractSceneDesignChange = () => {
  ...
  abstractSceneComputerDesign.style.justifyContent = "space-around";
  const computerPlayCard = document.getElementById("computer-play-card");
  computerPlayCard.innerHTML = `<img src="${imgBackPrefix}abstractScene.png" style="box-shadow:-1rem -1rem 1rem 0px rgba(0, 0, 0, 0.7);"></img>`;
  ...
  abstractScenePlayerDesign.style.justifyContent = "space-around";
  const playerPlayCard = document.getElementById("player-play-card");
  playerPlayCard.innerHTML = `<img src="${imgBackPrefix}abstractScene.png" style="box-shadow:-1rem -1rem 1rem 0px rgba(0, 0, 0, 0.7);"></img>`;
};
...
const handleCarsDesignChange = () => {
  ...
  carsComputerDesign.style.justifyContent = "space-around";
  const computerPlayCard = document.getElementById("computer-play-card");
  computerPlayCard.innerHTML = `<img src="${imgBackPrefix}cars.png" style="box-shadow:-1rem -1rem 1rem 0px rgba(0, 0, 0, 0.7);"></img>`;
  ...
  carsPlayerDesign.style.justifyContent = "space-around";
  const playerPlayCard = document.getElementById("player-play-card");
  playerPlayCard.innerHTML = `<img src="${imgBackPrefix}cars.png" style="box-shadow:-1rem -1rem 1rem 0px rgba(0, 0, 0, 0.7);"></img>`;
};
...
const handleAstronautDesignChange = () => {
  ...
  astronautComputerDesign.style.justifyContent = "space-around";
  const computerPlayCard = document.getElementById("computer-play-card");
  computerPlayCard.innerHTML = `<img src="${imgBackPrefix}astronaut.png" style="box-shadow:-1rem -1rem 1rem 0px rgba(0, 0, 0, 0.7);"></img>`;
  ...
  astronautPlayerDesign.style.justifyContent = "space-around";
  const playerPlayCard = document.getElementById("player-play-card");
  playerPlayCard.innerHTML = `<img src="${imgBackPrefix}astronaut.png" style="box-shadow:-1rem -1rem 1rem 0px rgba(0, 0, 0, 0.7);"></img>`;
};
...
const handleFrogDesignChange = () => {
  ...
  frogComputerDesign.style.justifyContent = "space-around";
  const computerPlayCard = document.getElementById("computer-play-card");
  computerPlayCard.innerHTML = `<img src="${imgBackPrefix}frog.png" style="box-shadow:-1rem -1rem 1rem 0px rgba(0, 0, 0, 0.7);"></img>`;
  ...
  frogPlayerDesign.style.justifyContent = "space-around";
  const playerPlayCard = document.getElementById("player-play-card");
  playerPlayCard.innerHTML = `<img src="${imgBackPrefix}frog.png" style="box-shadow:-1rem -1rem 1rem 0px rgba(0, 0, 0, 0.7);"></img>`;
};
...
const handleFishDesignChange = () => {
  ...
  fishComputerDesign.style.justifyContent = "space-around";
  const computerPlayCard = document.getElementById("computer-play-card");
  computerPlayCard.innerHTML = `<img src="${imgBackPrefix}fish.png" style="box-shadow:-1rem -1rem 1rem 0px rgba(0, 0, 0, 0.7);"></img>`;
  ...
  fishPlayerDesign.style.justifyContent = "space-around";
  const playerPlayCard = document.getElementById("player-play-card");
  playerPlayCard.innerHTML = `<img src="${imgBackPrefix}fish.png" style="box-shadow:-1rem -1rem 1rem 0px rgba(0, 0, 0, 0.7);"></img>`;
};
